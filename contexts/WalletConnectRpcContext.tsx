...
import { AddCatTokenRequest, AddCatTokenResponse } from '../types/walletconnect/rpc/AddCatToken';
...
import {
	CancelDataLayerOfferRequest,
	CancelDataLayerOfferResponse,
} from '../types/walletconnect/rpc/CancelDataLayerOffer';
import { CancelOfferRequest, CancelOfferResponse } from '../types/walletconnect/rpc/CancelOffer';
import { CheckOfferValidityRequest, CheckOfferValidityResponse } from '../types/walletconnect/rpc/CheckOfferValidity';
...
import { CreateOfferForIdsRequest, CreateOfferForIdsResponse } from '../types/walletconnect/rpc/CreateOfferForIds';
...
import { GetAllOffersRequest, GetAllOffersResponse } from '../types/walletconnect/rpc/GetAllOffers';
import { GetAncestorsRequest, GetAncestorsResponse } from '../types/walletconnect/rpc/GetAncestors';
import { GetCatAssetIdRequest, GetCatAssetIdResponse } from '../types/walletconnect/rpc/GetCatAssetId';
import { GetCatWalletInfoRequest, GetCatWalletInfoResponse } from '../types/walletconnect/rpc/GetCatWalletInfo';
import { GetCurrentAddressRequest, GetCurrentAddressResponse } from '../types/walletconnect/rpc/GetCurrentAddress';
import { GetDIDRequest, GetDIDResponse } from '../types/walletconnect/rpc/GetDID';
import {
	GetDIDCurrentCoinInfoRequest,
	GetDIDCurrentCoinInfoResponse,
} from '../types/walletconnect/rpc/GetDIDCurrentCoinInfo';
import { GetDIDInfoRequest, GetDIDInfoResponse } from '../types/walletconnect/rpc/GetDIDInfo';
import {
	GetDIDInformationNeededForRecoveryRequest,
	GetDIDInformationNeededForRecoveryResponse,
} from '../types/walletconnect/rpc/GetDIDInformationNeededForRecovery';
...
import {
	GetDataLayerSyncStatusRequest,
	GetDataLayerSyncStatusResponse,
} from '../types/walletconnect/rpc/GetDataLayerSyncStatus';
...
import { GetNextAddressRequest, GetNextAddressResponse } from '../types/walletconnect/rpc/GetNextAddress';
import { GetNftInfoRequest, GetNftInfoResponse } from '../types/walletconnect/rpc/GetNftInfo';
import {
	GetNftWalletsWithDIDsRequest,
	GetNftWalletsWithDIDsResponse,
} from '../types/walletconnect/rpc/GetNftWalletsWithDIDs';
import { GetNftsRequest, GetNftsResponse } from '../types/walletconnect/rpc/GetNfts';
import { GetNftsCountRequest, GetNftsCountResponse } from '../types/walletconnect/rpc/GetNftsCount';
import { GetOfferDataRequest, GetOfferDataResponse } from '../types/walletconnect/rpc/GetOfferData';
import { GetOfferRecordRequest, GetOfferRecordResponse } from '../types/walletconnect/rpc/GetOfferRecord';
import { GetOfferSummaryRequest, GetOfferSummaryResponse } from '../types/walletconnect/rpc/GetOfferSummary';
import { GetOffersCountRequest, GetOffersCountResponse } from '../types/walletconnect/rpc/GetOffersCount';
...
import { GetSyncStatusRequest, GetSyncStatusResponse } from '../types/walletconnect/rpc/GetSyncStatus';
import { GetTransactionRequest, GetTransactionResponse } from '../types/walletconnect/rpc/GetTransaction';
import { GetValueRequest, GetValueResponse } from '../types/walletconnect/rpc/GetValue';
import { GetWalletBalanceRequest, GetWalletBalanceResponse } from '../types/walletconnect/rpc/GetWalletBalance';
...
import { MintNftRequest, MintNftResponse } from '../types/walletconnect/rpc/MintNft';
...
} from '../types/walletconnect/rpc/RemoveSubscriptions';
import { RequestPermissionsRequest, RequestPermissionsResponse } from '../types/walletconnect/rpc/RequestPermissions';
import { SendTransactionRequest, SendTransactionResponse } from '../types/walletconnect/rpc/SendTransaction';
...
import { SignMessageByIdRequest, SignMessageByIdResponse } from '../types/walletconnect/rpc/SignMessageById';
...
import { TransferNftRequest, TransferNftResponse } from '../types/walletconnect/rpc/TransferNft';
...
import {
	UpdateDIDRecoveryIdsRequest,
	UpdateDIDRecoveryIdsResponse,
} from '../types/walletconnect/rpc/UpdateDIDRecoveryIds';
import { VerifyOfferRequest, VerifyOfferResponse } from '../types/walletconnect/rpc/VerifyOffer';
import { VerifySignatureRequest, VerifySignatureResponse } from '../types/walletconnect/rpc/VerifySignature';
...
interface WalletConnectRpc {
	...
	getWalletBalance: (data: GetWalletBalanceRequest) => Promise<GetWalletBalanceResponse>;
	signMessageById: (data: SignMessageByIdRequest) => Promise<SignMessageByIdResponse>;
	getCurrentAddress: (data: GetCurrentAddressRequest) => Promise<GetCurrentAddressResponse>;
	pushTx: (data: PushTxRequest) => Promise<PushTxResponse>;
	sendTransaction: (data: SendTransactionRequest) => Promise<SendTransactionResponse>;
	signMessageByAddress: (data: SignMessageByAddressRequest) => Promise<SignMessageByAddressResponse>;
	verifySignature: (data: VerifySignatureRequest) => Promise<VerifySignatureResponse>;
	getNextAddress: (data: GetNextAddressRequest) => Promise<GetNextAddressResponse>;
	...
	getOffersCount: (data: GetOffersCountRequest) => Promise<GetOffersCountResponse>;
	createOfferForIds: (data: CreateOfferForIdsRequest) => Promise<CreateOfferForIdsResponse>;
	cancelOffer: (data: CancelOfferRequest) => Promise<CancelOfferResponse>;
	checkOfferValidity: (data: CheckOfferValidityRequest) => Promise<CheckOfferValidityResponse>;
	takeOffer: (data: TakeOfferRequest) => Promise<TakeOfferResponse>;
	getOfferSummary: (data: GetOfferSummaryRequest) => Promise<GetOfferSummaryResponse>;
	getOfferData: (data: GetOfferDataRequest) => Promise<GetOfferDataResponse>;
	getOfferRecord: (data: GetOfferRecordRequest) => Promise<GetOfferRecordResponse>;

	// CATs
	getCatWalletInfo: (data: GetCatWalletInfoRequest) => Promise<GetCatWalletInfoResponse>;
	...
	// DIDs
	createNewDIDWallet: (data: CreateNewDIDWalletRequest) => Promise<CreateNewDIDWalletResponse>;
	// didCreateAttest: (
	...
	findLostDID: (data: FindLostDIDRequest) => Promise<FindLostDIDResponse>;
	getDIDCurrentCoinInfo: (data: GetDIDCurrentCoinInfoRequest) => Promise<GetDIDCurrentCoinInfoResponse>;
	...
	getDIDMetadata: (data: GetDIDMetadataRequest) => Promise<GetDIDMetadataResponse>;
	getDIDPubkey: (data: GetDIDPubkeyRequest) => Promise<GetDIDPubkeyResponse>;
	getDIDRecoveryList: (data: GetDIDRecoveryListRequest) => Promise<GetDIDRecoveryListResponse>;
	getDIDName: (data: GetDIDNameRequest) => Promise<GetDIDNameResponse>;
	// messageSpend: (
	...
	transferDID: (data: TransferDIDRequest) => Promise<TransferDIDResponse>;
	updateDIDMetadata: (data: UpdateDIDMetadataRequest) => Promise<UpdateDIDMetadataResponse>;
	updateDIDRecoveryIds: (data: UpdateDIDRecoveryIdsRequest) => Promise<UpdateDIDRecoveryIdsResponse>;
	setDIDName: (data: SetDIDNameRequest) => Promise<SetDIDNameResponse>;
	setNftDID: (data: SetNftDIDRequest) => Promise<SetNftDIDResponse>;
	getNftWalletsWithDIDs: (data: GetNftWalletsWithDIDsRequest) => Promise<GetNftWalletsWithDIDsResponse>;

	requestPermissions: (data: RequestPermissionsRequest) => Promise<RequestPermissionsResponse>;
}
...
export function WalletConnectRpcProvider({ children }: PropsWithChildren) {
	...
	async function getTransaction(data: GetTransactionRequest) {
		return request<GetTransactionResponse>(ChiaMethod.GetTransaction, data);
	}

	async function getWalletBalance(data: GetWalletBalanceRequest) {
		return request<GetWalletBalanceResponse>(ChiaMethod.GetWalletBalance, data);
	}

	async function getCurrentAddress(data: GetCurrentAddressRequest) {
		return request<GetCurrentAddressResponse>(ChiaMethod.GetCurrentAddress, data);
	}

	async function sendTransaction(data: SendTransactionRequest) {
		return request<SendTransactionResponse>(ChiaMethod.SendTransaction, data);
	}

	async function signMessageById(data: SignMessageByIdRequest) {
		return request<SignMessageByIdResponse>(ChiaMethod.SignMessageById, data);
	}

	async function signMessageByAddress(data: SignMessageByAddressRequest) {
		return request<SignMessageByAddressResponse>(ChiaMethod.SignMessageByAddress, data);
	}

	async function verifySignature(data: VerifySignatureRequest) {
		return request<VerifySignatureResponse>(ChiaMethod.VerifySignature, data);
	}

	async function getNextAddress(data: GetNextAddressRequest) {
		return request<GetNextAddressResponse>(ChiaMethod.GetNextAddress, data);
	}

	async function getSyncStatus(data: GetSyncStatusRequest) {
		return request<GetSyncStatusResponse>(ChiaMethod.GetSyncStatus, data);
	}

	// Offers

	async function getAllOffers(data: GetAllOffersRequest) {
		return request<GetAllOffersResponse>(ChiaMethod.GetAllOffers, data);
	}

	async function getOffersCount(data: GetOffersCountRequest) {
		return request<GetOffersCountResponse>(ChiaMethod.GetOffersCount, data);
	}

	async function createOfferForIds(data: CreateOfferForIdsRequest) {
		return request<CreateOfferForIdsResponse>(ChiaMethod.CreateOfferForIds, data);
	}
	...
	async function checkOfferValidity(data: CheckOfferValidityRequest) {
		return request<CheckOfferValidityResponse>(ChiaMethod.CheckOfferValidity, data);
	}
	...
	async function getOfferSummary(data: GetOfferSummaryRequest) {
		return request<GetOfferSummaryResponse>(ChiaMethod.GetOfferSummary, data);
	}

	async function getOfferData(data: GetOfferDataRequest) {
		return request<GetOfferDataResponse>(ChiaMethod.GetOfferData, data);
	}

	async function getOfferRecord(data: GetOfferRecordRequest) {
		return request<GetOfferRecordResponse>(ChiaMethod.GetOfferRecord, data);
	}

	// CATs

	async function getCatWalletInfo(data: GetCatWalletInfoRequest) {
		return request<GetCatWalletInfoResponse>(ChiaMethod.GetCatWalletInfo, data);
	}

	async function getCatAssetId(data: GetCatAssetIdRequest) {
		return request<GetCatAssetIdResponse>(ChiaMethod.GetCatAssetId, data);
	}
	...
	async function getNftsCount(data: GetNftsCountRequest) {
		return request<GetNftsCountResponse>(ChiaMethod.GetNftsCount, data);
	}
	...
	async function createNewDIDWallet(data: CreateNewDIDWalletRequest) {
		return request<CreateNewDIDWalletResponse>(ChiaMethod.CreateNewDIDWallet, data);
	}
	...
	async function findLostDID(data: FindLostDIDRequest) {
		return request<FindLostDIDResponse>(ChiaMethod.FindLostDID, data);
	}
	async function getDIDCurrentCoinInfo(data: GetDIDCurrentCoinInfoRequest) {
		return request<GetDIDCurrentCoinInfoResponse>(ChiaMethod.GetDIDCurrentCoinInfo, data);
	}
	async function getDID(data: GetDIDRequest) {
		return request<GetDIDResponse>(ChiaMethod.GetDID, data);
	}
	async function getDIDInfo(data: GetDIDInfoRequest) {
		return request<GetDIDInfoResponse>(ChiaMethod.GetDIDInfo, data);
	}
	async function getDIDInformationNeededForRecovery(data: GetDIDInformationNeededForRecoveryRequest) {
		return request<GetDIDInformationNeededForRecoveryResponse>(ChiaMethod.GetDIDInformationNeededForRecovery, data);
	}
	async function getDIDMetadata(data: GetDIDMetadataRequest) {
		return request<GetDIDMetadataResponse>(ChiaMethod.GetDIDMetadata, data);
	}
	async function getDIDPubkey(data: GetDIDPubkeyRequest) {
		return request<GetDIDPubkeyResponse>(ChiaMethod.GetDIDPubkey, data);
	}
	async function getDIDRecoveryList(data: GetDIDRecoveryListRequest) {
		return request<GetDIDRecoveryListResponse>(ChiaMethod.GetDIDRecoveryList, data);
	}
	async function getDIDName(data: GetDIDNameRequest) {
		return request<GetDIDNameResponse>(ChiaMethod.GetDIDName, data);
	}
	...
	async function transferDID(data: TransferDIDRequest) {
		return request<TransferDIDResponse>(ChiaMethod.TransferDID, data);
	}
	async function updateDIDMetadata(data: UpdateDIDMetadataRequest) {
		return request<UpdateDIDMetadataResponse>(ChiaMethod.UpdateDIDMetadata, data);
	}
	async function updateDIDRecoveryIds(data: UpdateDIDRecoveryIdsRequest) {
		return request<UpdateDIDRecoveryIdsResponse>(ChiaMethod.UpdateDIDRecoveryIds, data);
	}
	...
	async function getNftWalletsWithDIDs(data: GetNftWalletsWithDIDsRequest) {
		return request<GetNftWalletsWithDIDsResponse>(ChiaMethod.GetNftWalletsWithDIDs, data);
	}

	async function requestPermissions(data: RequestPermissionsRequest) {
		return request<RequestPermissionsResponse>(ChiaMethod.RequestPermissions, data);
	}
...
export function useWalletConnectRpc() {
	...
	if (!context) throw new Error('Calls to `useWalletConnectRpc` must be used within a `WalletConnectRpcProvider`.');
