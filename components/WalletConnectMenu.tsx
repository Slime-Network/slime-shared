...
const WalletConnectMenu: React.FC<WalletConnectMenuProps> = ({ session, connectToWallet, disconnectFromWallet }) => {
	...
	const renderWalletMenu = (
		...
		>
			...
			{session ? (
				<div>
					<MenuItem onClick={handleDisconnectFromWallet}>
						<ListItemIcon>
				...
				<div>
					<MenuItem onClick={handleConnectToWallet}>
						<ListItemIcon>
							<AccountBalanceWalletIcon fontSize="small" />
						</ListItemIcon>
						Connect to Chia Wallet
					</MenuItem>
					<MenuItem onClick={purgeWcConnections}>
						<ListItemIcon>
							<AccountBalanceWalletIcon fontSize="small" />
						</ListItemIcon>
						Purge Connections
	...
	return (
		<div>
			<IconButton size="large" edge="end" aria-label="" aria-haspopup="true" color="inherit" onClick={openWalletMenu}>
				{session ? (
					<Badge
						variant="dot"
						overlap="circular"
